...
import { CheckCircle, Calendar, CreditCard, FileText, Home, User } from 'lucide-react';
                ...
                <Card className="mb-6 shadow-lg border-0">
                    ...
                    <CardContent className="p-6">
                        <div className="space-y-3 text-gray-600">
                            ...
                            <div className="flex items-start gap-3">
                                <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                                <p>Đội ngũ tư vấn sẽ liên hệ với bạn trong vòng 24 giờ để xác nhận thông tin chi tiết.</p>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                                <p>Bạn có thể xem và quản lý đặt tour trong mục "Đặt tour của tôi".</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
