...
export const RegisterPartnerForm: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await registerPartnerService.createRegisterPartner(
        submitData
      );
      if (response.success) {
        setShowSuccess(true);
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Cảm ơn bạn đã đăng ký đối tác. Chúng tôi sẽ liên hệ với bạn
            ...
            <div className="flex justify-between pt-6">
              ...
              {currentStep < TOTAL_STEPS ? (
                ...
                <Button onClick={handleSubmit} disabled={isSubmitting}>
                  {isSubmitting ? "Đang gửi..." : "Gửi đăng ký đối tác"}
                </Button>
              )}
            </div>
          </CardContent>
