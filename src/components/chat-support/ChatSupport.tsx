...
export const ChatSupport: React.FC = () => {
    ...
    const [newProviderProfile, setNewProviderProfile] = useState<{ id: number; company_name: string; avatar: string } | null>(null);
    ...
    const handleSendMessageWithProvider = () => {
        handleSendMessage(newProviderProfile?.id);
    };
        ...
        const handleProviderParam = async () => {
            ...
            if (conversationWithProvider) {
                ...
                try {
                    ...
                    const providerResponse = await getProviderProfileById(targetProviderId);
    ...
    const handleConversationSelectWithUrl = (conversationId: number, providerId: number) => {
