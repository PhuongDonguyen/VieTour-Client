...
const LockUserModal: React.FC<LockUserModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onConfirm(user.account_id || user.id, lockedUntilDate);
  };
          ...
          <div className="p-6 space-y-4">
            <div>
              <p className="text-sm text-gray-600 mb-4">
                Bạn đang khóa tài khoản của <span className="font-medium text-gray-900">{user.first_name} {user.last_name}</span>
              </p>
            </div>
